 ...
 */
public class CheckersClientSupport {
    ...
    public CheckersClientSupport(String name, IoHandler handler) {
        if (name == null) {
...
//                session.getCloseFuture().awaitUninterruptibly();
	...
	public void move(String name, CheckersMove move) {
		GameMove moveMsg = MessageFactory.instance.gameMove(name, move.toString());
		session.write(moveMsg.getRawMessage());
	}
