...
public class ConnectDialog extends JDialog {
    ...
    public ConnectDialog(Frame owner) throws HeadlessException {
        ...
        serverAddress = prefs.get("server", "localhost:15337");
        username = prefs.get("user", "user" + Math.round(Math.random() * 1024));
